...
run PEP8 pycodestyle Ex_bandpass.py Ex_cleaning.py Ex_cnn.py Ex_contigs.py Ex_spectra.py Clean.py ML.py Plots.py Prep.py Signals.py Standard.py config.py test_preprocessing.py
assert_no_stdout
